...
{
    resize(1120, 630);
    setStyleSheet("MyTutorial {background-image: url(/home/kahrabian/ClionProjects/Shooter-AP93UT/Contents/background_menu.jpg);}");
...
void MyTutorial::construct_text()
{
    ...
    text->setStyleSheet("background-color: rgba(0, 0, 0, 60%); color : #99FF33; font-size: 25pt");
